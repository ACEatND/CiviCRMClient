...
function LoginUser(a)
{
    ...
    $().crmRESTAPI_POST('', 'login',
		   ...
		   api_key: API_KEY,
               ...
               {
                   ajaxURL: "http://devace.cloudaccess.net/administrator/index.php",
...
function yahooPlaceFinderGeocode(address, settings) {
    ...
    var geoAPI = 'http://maps.googleapis.com/maps/api/geocode/json' // + escape(address) + '&sensor=true';
