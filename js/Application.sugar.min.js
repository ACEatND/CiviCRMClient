...
**
****************************************************************/
//var defOptions {ajaxURL:"http://nwtest1.info/drupal7/sites/all/modules/civicrm/extern/rest.php"};

var SERVER_REST_URL = "http://nwtest1.info/drupal7/sites/all/modules/civicrm/extern/rest.php";
var API_KEY = "e81d68b70bf21723fb9f3088a446b6e5";
...
RES_RELATED_ITEM_NAME_LABEL = "Name",
RES_TYPE_LABEL = "Type",
RES_NAME_LABEL = "Name",
...
RES_ASSIGNED_TO_LABEL = "Assigned To",
...
$("#AccountsListPage").live("pageshow", function () {
    CiviCRMGetAccountsListFromServer(AccountsListCurrentOffset)
});
$("#ContactsListPage").live("pageshow", function () {
    CiviCRMGetContactListFromServer(ContactsListCurrentOffset)
});
...
$("#HomePage").live("pageshow", function () {
    CiviSessionId === "" && $.mobile.changePage("#LoginPage")
});
                   ...
                   success: function (result, settings) {
                       if (result) {
                           if (result.is_error == 0) {
                               CiviSessionId = result.PHPSESSID;
                               Session_Api_Key = result.key;
...
function LogCall(a, c) {
    $.get(SERVER_REST_URL, {
        ...
        input_type: "JSON",
        response_type: "JSON",
        rest_data: '{"session":"' + CiviSessionId + '","module_name":"' + a + '","name_value_list":[{"name":"name","value":"Call placed from mobile device"},{"name":"direction","value":"Outbound"},{"name":"parent_type","value":"' + a + '"},{"name":"parent_id","value":"' + c + '"},{"name":"status","value":"Test"},{"name":"duration_hours","value":0},{"name":"duration_minutes","value":0}]}'
    },
	function (b) {
	    alert(b)
	})
}
function CiviCRMGetAccountsListFromServer(a) {
    if ($("#AllAccountsListDiv li").length === 0 || AccountsListCurrentOffset !== a) {
        ...
        $.get(SERVER_REST_URL, {
            ...
            input_type: "JSON",
            response_type: "JSON",
            rest_data: '{"session":"' + CiviSessionId + '","module_name":"Accounts","query":"","order_by":"name","offset":' + a + ',"select_fields":["name","billing_address_city","billing_address_state"],"link_name_to_fields_array":"","max_results":' + RowsPerPageInListViews + ',"deleted":0}'
        },
		function (c) {
		    if (c !== undefined) {
...
function CiviCRMGetAccountDetails() {
    ...
    $.get(SERVER_REST_URL, {
        ...
        input_type: "JSON",
        response_type: "JSON",
        rest_data: '{"session":"' + CiviSessionId + '","module_name":"Accounts","id":"' + CurrentAccountId + '","select_fields":"","link_name_to_fields_array":""}'
    },
	function (a) {
	    if (a !== undefined) {
	        ...
	        if (a !== undefined && a.entry_list !== undefined) if (a.entry_list[0] !== undefined) {
	            ...
	            if (a.name_value_list.website.value !== "") {
	                b = "";
	                b = a.name_value_list.website.value.substring(0, 4) !== "http" ? "http://" + a.name_value_list.website.value : a.name_value_list.website.value;
	                c = $("<li/>");
				...
				n = $("<a/>", {
				    href: "http://maps.google.com/?q=" + f + " " + e + " " + m + " " + g + "&t=m&z=13",
				    rel: "external",
				    target: "_new",
				    style: "text-decoration:none;color:#444;"
				});
	            ...
	            b.append(d);
	            c.append(b);
	            a.name_value_list.email1.value !== "" && $("#ViewAccountDetailsPageDetailsList").append(c);
	            ...
	            a.name_value_list.industry !== undefined && a.name_value_list.industry.value !== "" && $("#ViewAccountDetailsPageDetailsList").append("<li><p><br />Industry</p><h4>" + a.name_value_list.industry.value + "</h4></li>");
	            ...
	            a.name_value_list.sic_code !== undefined && a.name_value_list.sic_code.value !== "" && $("#ViewAccountDetailsPageDetailsList").append("<li><P><br />SIC Code</p><h4>" + a.name_value_list.sic_code.value + "</h4></li>");
	            ...
	            a.name_value_list.parent_name !== undefined && a.name_value_list.parent_name.value !== "" && $("#ViewAccountDetailsPageDetailsList").append("<li><p><br />Member of</p><h4>" + a.name_value_list.parent_name.value + "</h4></li>");
	            ...
	            a.name_value_list.rating !== undefined && a.name_value_list.rating.value !== "" && $("#ViewAccountDetailsPageDetailsList").append("<li><p><br />Rating</p><h4>" + a.name_value_list.rating.value + "</h4></li>");
	            ...
	            a.name_value_list.date_modified !== undefined && a.name_value_list.date_modified.value !== "" && $("#ViewAccountDetailsPageDetailsList").append("<li><p><br />Date Modified</p><h4>" + a.name_value_list.date_modified.value + "</h4></li>");
    ...
    $.get(SERVER_REST_URL, {
        ...
        input_type: "JSON",
        response_type: "JSON",
        rest_data: '{"session":"' + CiviSessionId + '","module_name":"Accounts","module_id":"' + CurrentAccountId + '","link_field_name":"contacts","related_module_query":"","related_fields":["id","first_name","last_name","title"],"related_module_link_name_to_fields_array":"","deleted":0}'
    },
	function (a) {
    ...
    $.get(SERVER_REST_URL, {
        ...
        input_type: "JSON",
        response_type: "JSON",
        rest_data: '{"session":"' + CiviSessionId + '","module_name":"Accounts","module_id":"' + CurrentAccountId + '","link_field_name":"opportunities","related_module_query":"","related_fields":["id","name","sales_stage"],"related_module_link_name_to_fields_array":"","deleted":0}'
    },
	function (a) {
    ...
    $.get(SERVER_REST_URL, {
        ...
        input_type: "JSON",
        response_type: "JSON",
        rest_data: '{"session":"' + CiviSessionId + '","module_name":"Accounts","module_id":"' + CurrentAccountId + '","link_field_name":"leads","related_module_query":"","related_fields":["id","first_name","last_name","title"],"related_module_link_name_to_fields_array":"","deleted":0}'
    },
	function (a) {
    ...
    $.get(SERVER_REST_URL, {
        ...
        input_type: "JSON",
        response_type: "JSON",
        rest_data: '{"session":"' + CiviSessionId + '","module_name":"Accounts","module_id":"' + CurrentAccountId + '","link_field_name":"calls","related_module_query":"","related_fields":["id","name","status","date_start"],"related_module_link_name_to_fields_array":"","deleted":0}'
    },
	function (a) {
    ...
    $.get(SERVER_REST_URL, {
        ...
        input_type: "JSON",
        response_type: "JSON",
        rest_data: '{"session":"' + CiviSessionId + '","module_name":"Accounts","module_id":"' + CurrentAccountId + '","link_field_name":"meetings","related_module_query":"","related_fields":["id","name","status","date_start"],"related_module_link_name_to_fields_array":"","deleted":0}'
    },
	function (a) {
    ...
    $.get(SERVER_REST_URL, {
        ...
        input_type: "JSON",
        response_type: "JSON",
        rest_data: '{"session":"' + CiviSessionId + '","module_name":"Accounts","module_id":"' + CurrentAccountId + '","link_field_name":"tasks","related_module_query":"","related_fields":["id","name","status","date_start"],"related_module_link_name_to_fields_array":"","deleted":0}'
    },
	function (a) {
...
function CiviCRMGetContactListFromServer(a) {
    if ($("#AllContactsListDiv li").length === 0 || ContactsListCurrentOffset !== a) {
        $.mobile.pageLoading();
        ContactsListCurrentOffset = a;

        //            rest_data: '{"session":"' + CiviSessionId + '","module_name":"Contacts","query":"","order_by":"name","offset":' + a + ',"select_fields":["first_name","last_name","account_name","title"],"link_name_to_fields_array":"","max_results":' + RowsPerPageInListViews + ',"deleted":0}'

    $().crmAPI('civicrm_contact', 'get',
               {
                    q: 'civicrm/contact/get',
                    api_key: API_KEY,
                    key: Session_Api_Key,
                    PHPSESSID: CiviSessionId
               },
               {
                    ajaxURL: SERVER_REST_URL,
                    success: function (result, settings) {
			...
			$.each(result.values, function(index, value) {
				$('#AllContactsListDiv').append('<li role="option" tabindex="-1" data-theme="c" id="contact-'+value.contact_id+'" ><a href="'+value.contact_id+'" data-ajax="false">'+value.display_name+' </a></li>');
				//<a href="#contact/'+value.contact_id+'" data-role="contact-'+value.contact_id+'">'+value.display_name+'</a>
			});

            /*
		                                var b = 0;
		                                for (b = 0; b <= result.values.length; b++) if (result.entry_list[b] != undefined) {
		                                    var d = c.entry_list[b],
			                                f = $("<li/>"),
        ...
        $.get(SERVER_REST_URL, {
            ...
            input_type: "JSON",
            response_type: "JSON",
            rest_data: '{"session":"' + CiviSessionId + '","module_name":"Contacts","query":"","order_by":"first_name","offset":' + a + ',"select_fields":["first_name","last_name","title"],"link_name_to_fields_array":"","max_results":' + RowsPerPageInListViews + ',"deleted":0}'
        },
		function (c) {
		    if (c != undefined) {
		        c = jQuery.parseJSON(c);
	    ...
	    if (a != undefined) {
	        ...
	        if (a != undefined && a.entry_list != undefined) if (a.entry_list[0] != undefined) {
	            ...
	            if (a.name_value_list.alt_address_street !== undefined && a.name_value_list.alt_address_street.value != "" || a.name_value_list.alt_address_city !== undefined && a.name_value_list.alt_address_city.value != "" || a.name_value_list.alt_address_state !== undefined && a.name_value_list.alt_address_state.value != "" || a.name_value_list.alt_address_postalcode !== undefined && a.name_value_list.alt_address_postalcode.value != "" || a.name_value_list.alt_address_country !== undefined && a.name_value_list.alt_address_country.value != "") {
	                ...
	                d = $("<a/>", {
	                    href: "http://maps.google.com/?q=" + d + " " + f + " " + e + " " + m + "&t=m&z=13",
	                    rel: "external",
	                    target: "_new",
	                    style: "text-decoration:none;color:#444;"
	                });
...
function CiviCRMGetMeetingDetails() {
    ...
    $.get(SERVER_REST_URL, {
        ...
        input_type: "JSON",
        response_type: "JSON",
        rest_data: '{"session":"' + CiviSessionId + '","module_name":"Meetings","id":"' + CurrentMeetingId + '","select_fields":"","link_name_to_fields_array":""}'
    },
	function (a) {
	    if (a != undefined) {
	        a = jQuery.parseJSON(a);
	        ...
	        if (a != undefined && a.entry_list != undefined) if (a.entry_list[0] != undefined) {
	            ...
	            a.name_value_list.date_modified !== undefined && a.name_value_list.date_modified.value !== "" && $("#ViewMeetingDetailsPageDetailsList").append("<li><p><br />Date Modified</p><h4>" + a.name_value_list.date_modified.value + "&nbsp;by&nbsp;" + a.name_value_list.modified_by_name.value + "</h4></li>");
