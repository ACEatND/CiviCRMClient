...
(function($){
      var defaults = {
    	  ...
    	  ajaxURL: '/civicrm/extern/rest.php',
    	  msgbox: '#restmsg',
          cache: false
      };

      $.fn.crmRESTAPI = function(entity,action,params,options) {
          if (entity && entity.length > 0) {
              params ['q'] = "civicrm/" + entity + "/"+action;
          } else {
              params ['q'] = "civicrm/" + action;
          }
    ...
    $.fn.crmRESTAutocomplete = function (params,options) {
